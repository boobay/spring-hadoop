...
<beans xmlns="http://www.springframework.org/schema/beans"
  ...
  xsi:schemaLocation="
    ...
    http://www.springframework.org/schema/yarn/spring-yarn.xsd<!--7-->
    http://www.springframework.org/schema/yarn/integration
    http://www.springframework.org/schema/yarn/integration/spring-yarn-integration.xsd<!--8-->
...
at any time it is considered bad design if one chooses to do so. Spring
...
For convenience, it is possible to define a classpath entry directly into
